...
<FORM ENCTYPE="multipart/form-data" ACTION="index.php" METHOD="post">
  ...
  <div class="well well-large" align="left">
      <div class="controls">
  <label class="control-label" for="file1">Selecciona el archivo comprimido descargado desde SÈneca <span style="color:#9d261d">Exportacion_Faltas_Alumnado.zip</span>
  </label>
  <hr />
...
<hr />
  <div class="help-block" style="text-align:justify; <?php if($error) echo 'color: red;';?>"><p class="lead text-warning">InformaciÛn sobre la ImportaciÛn.</p>
...
</html>ÃôLΩµM'¨;ìºõ°âù2lÚ5|Vã,!◊¶•u¨∫}øÛå›ru‘ˆåÖÍDïÎŒIU÷µ*1,é