...
$asignatur1 = mysqli_query($db_con, "SELECT distinct  c_asig, a_asig FROM  horw where prof = '$profesor' and dia = '$z' and hora = '$n_hora'");
...
// Recorremos los grupos a los que da en ese hora.
	$asignaturas1 = mysqli_query($db_con, "SELECT distinct  c_asig, a_grupo FROM  horw where prof = '$profesor' and dia = '$z' and hora = '$n_hora' AND a_grupo not like 'G%'");
