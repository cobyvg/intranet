...
<p>El módulo de <b><em>Faltas de Asistencia</em></b> incluye estas
funciones: poner faltas; justificarlas (si el cargo es Tutor); consultar
las faltas de múltiples maneras; hacer un seguimiento de los Alumnos
Absentistas (Tutores, Jefatura, Orientación y Servicios Sociales
municipales); subir las faltas de asistencia registradas a Séneca (si
utilizamos la aplicación para poner las faltas, una vez al mes se suben
a Séneca); y descargar las faltas de asistencia desde Séneca (si no
utilizamos la aplicación para poner las faltas pero queremos incorporar
las faltas a la Intranet para incluirlas en otros módulos -Informes de
alumnos, envío de SMS a las familias, Memoria de Tutoría, Cuaderno del
Profesor, etc.).</p>
<h5>Poner faltas a los Alumnos</h5>
<p>La página por defecto para poner las faltas es un formulario muy
simple (similar a la aplicación <em>iSéneca</em> de la Consejería),
pensado para ser utilizado en el tiempo real de trabajo en el aula, pero
que también puede ser utilizado en cualquier momneto posterior. Se
ofrecen tres opciones: Falta No Justificada (F), Falta Justificada (J) o
Retraso (R).Está también adaptada para su uso en dispositivos móviles, y
aparece en el Menú de iconos específicos de estos dispositivos en la
página de inicio de la Intranet.<br>
Si estamos en una aula con alumnos impartiendo una asignatura, el módulo
...
tus asignaturas. Aparecerá la lista de tus alumnos y podrás marcar las
faltas. Envía las Faltas para guardarlas en la Base de datos. Si el
alumno está registrado en ese momento en una Actividad Complementaria o
el Tutor del mismo ya ha justificado de antemano la falta de esa hora,
no podremos marcar la falta. <br>
Hay un método alternativo para registrar las faltas semanalmente. Si
quieres utilizarlo, pulsa en el Menú superior sobre <em><b>Poner</b></em>
y se abrirá la página. Esta página te presenta un cuadrante con la
estructura de tu horario semanal. En cada día y hora en que das clase
aparecen los Grupos afectados. Selecciona en primer lugar un día de la
semana en la que quieres marcar las faltas. A continuación, escribe el
número de aula de los alumnos ausentes seguido de un punto (por ejemplo:
3.12.27.31.) en el campo de texto que se abre bajo cada Grupo. Cuando
hayas terminado con una semana envía los datos con el botón (<b><em>Registrar
las faltas de asistencia</em></b>). Selecciona otra semana y repite el
procedimiento.</p>
<h5>Consultas</h5>
<p>El módulo incluye un conjunto de diferentes tipos de consulta que
podemos hacer sobre las faltas de aistencia: Faltas de un alumnos, de un
Grupo, de una Asignatura, así como consultar que alumnos tienen un
...
seleccionado elige el mes correspondiente. Aparecerán en rojo las faltas
...
dejamos a cero.<br>
Si la falta no ha sido registrada todavía (el día del calendario no es
verde ni rojo), aparecerá un cuadro de diálogo en el que deberás
...
primer lugar la Consulta para seleccionar a los alumnos con más de 25
faltas de aistencia. Los marca de la lista y envía los datos. Una vez
registrados, los Tutores de los alumnos, Orientación y Equipo directivo
reciben una notificación en la página de entrada de la aplicación,
invitándoles a informar sobre el alumno y las razones (o ausencia de las
mismas) por las que este falta a sus clases. El Equipo directivo puede
añadir también información proporcionada por los Servicio de Asistencia
Social del Ayuntamiento.</p>
<h5>Administración</h5>
<p>Las Faltas de asistencia registradas en la Intranet pueden subirse a
Séneca. El enlace nos lleva a una página desde la que procedemos a
generar el archivo que posteriormente importamos a Séneca. La página
contiene información sobre la forma de hacerlo. <br>
Si no utilizamos la Intranet para poner las faltas, todavía podemos
beneficiarnos de contar con las faltas descargádolas desde Séneca e
incorporándolas a la aplicación. Son muchos los módulos que incluyen
información sobre las faltas de asistencia, y de este modo podemos
suministrarles los datos necesarios. El enlace nos presenta una página
para importar las faltas de Séneca con la información necesaria para
proceder.<br>
El <b><em>Informe de Faltas para Padres</em></b> presenta las cartas en formato PDF que
se envían a los papás con las faltas del nene, preparadas para imprimir, cuando proceda y por la razón que proceda. Presenta información sobre los días en que el alumno ha faltado al Centro, así como la normativa correspondiente.<br>

Si utilizamod el servicio de SMS interno de la aplicación aparecerá también <b><em>SMS de Faltas para Padres</em></b>. Nos permite hacer un envío masivo de SMS a los padres de los alumnos de un determinado Nivel. Un alumno entra en la lista de envío cuando tiene más de 5 faltas de asistencia sin justificar en el periodo seleccionado.<br>
Los <b><em>Partes de Faltas</em></b> ofrecen una lista completa de los partes de asistencia que se dejan en el aula para que firme y registre las faltas el profesor, si se sigue este método de control de la asistencia de los alumnos. El documento PDF se presenta en formato diario o semanal.<br>
...
alumnos. Cada profesor marca en su horario el número de clase de los
alumnos ausentes en una semana, y, o bien las registra posteriormente en
el módulo de <b><em>Poner faltas</em></b>, o bien lo entrega para que
