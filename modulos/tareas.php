...
if (mysql_num_rows($si) > 0)
	...
	<a href='./admin/tareas/infocompleto.php?id=$row1[0]' class='alert-link' rel='tooltip' title='Ver informe'><span class='fa fa-search fa-fw fa-lg'></span></a>
	<a href='./admin/tareas/informar.php?id=$row1[0]' class='alert-link' rel='tooltip' title='Rellenar'><span class='fa fa-pencil fa-fw fa-lg'></span></a>
	</span>
	</p>";
?>	
