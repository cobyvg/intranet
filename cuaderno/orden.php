...
<h2 class='no_imprimir'>Cuaderno de Notas&nbsp;&nbsp;<small>Orden de las columnas del Cuaderno</small></h2>
</div>
...
echo "<input name=hora value='$hora' type='hidden'>";
		?>
		<input type="submit" name="enviar" value="Aceptar" class="btn btn-default">
		</form>
		</div>
</div>
</div>
