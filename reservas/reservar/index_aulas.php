...
Si queremos asignar una hora a un profesor durante todo el curso escolar, seleccionamos al mismo en el formulario y pulsamos sobre el botÛn rojo <strong>Reservar todo el Curso</strong>. A partir de ese momento los profesores ver·n en ese campo la expresiÛn <strong>Asignada por DirecciÛn</strong></strong> y no podr·n elegir el aula en esa hora. Este procedimiento se puede aplicar tantas veces como queramos para aquellas dependencias o aulas que aparezcan en el horario.   
</small></p>
</div>
