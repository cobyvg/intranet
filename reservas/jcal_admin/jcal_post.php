...
if ($event_found == 1) {
  //UPDATE
    $postQuery = "UPDATE $servicio SET event1 = '$day_event_safe1', event2 = '$day_event_safe2', event3 = '$day_event_safe3', 
...
mysql_close($conn);
  ...
  //INSERT
    $postQuery = "INSERT INTO $servicio (eventdate,dia,event1,event2,event3,event4,event5,event6,event7,html) VALUES ('$sql_date','$numero_dia','$day_event_safe1','$day_event_safe2','$day_event_safe3','$day_event_safe4','$day_event_safe5','$day_event_safe6','$day_event_safe7','$show_html');";
    //    echo $postQuery;
