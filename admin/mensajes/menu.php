...
tiene configurado un Servidor de correo (algo habitual en estos días).<br>
<br>
La redacción de un mensaje interno comienza con la selección de un
...
Una vez elegido el destinatario del mensaje escibimos el título (corto y
explicativo, ya que es la cabecera que veremos en la página de entrada
de la Intranet) y contenido del mismo. El texto admite enlaces,
imágenes, etc.<br>
Los mensajes enviados y recibidos presentan los últimos 500 mensajes de
...
como también de la lista de mensajes enviados.<br>
<br>
Si queremos enviar un correo electrónico, elegimos los destinatarios de
...
<br>
Si el Centro tiene contratado un sistema de envío de SMS (la aplicación
está preparada para funcionar con SMSTREND, por ejemplo) y el profesor
pertenece a un perfil autorizado para utilizar el sistema (Equipo
directivo, Tutores, DACE, Orientación, etc.) se puede ennviar un SMS con
un máximo de 160 caracteres a los teléfonos registrados en Séneca por la
familia del alumno durante la matriculación. Si necsitamos seleccionar
múltiples alumnos de nuevo mantenemos presionada la tecla Ctrl mientras
los marcamos con el ratón.</p>
</div>
