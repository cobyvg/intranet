...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    ...
    <?php if($msg): ?>
    <div class="alert <?php echo $msg_class; ?> alert-block">
      <?php echo $msg; ?>       
    </div>
    <?php endif; ?>
    ...
    <div class="row-fluid">
       ...
       <div class="span7">
         <input type="text" class="input-block-level" name="tema" placeholder="Asunto">
         ...
         <div class="well">
           <fieldset id="fiel">
             <legend class="text-warning">Archivos adjuntos <small>(5 archivos máximo)</small></legend>
             <input type="button" class="btn btn-success" value="Añadir archivo adjunto" onclick="crear(this)">
             <br><br>
           </fieldset>
         </div>
       ...
       <div class="span5">
         ...
         <div class="well">
	         <a href="javascript:seleccionar_todo()" class="btn btn-mini btn-info">Todos</a>
	         <a href="javascript:seleccionar_tutor()" class="btn btn-mini btn-info">Tutores</a>
	         <a href="javascript:seleccionar_jd()" class="btn btn-mini btn-info">J. de Departamento</a>
	         <a href="javascript:seleccionar_ca()" class="btn btn-mini btn-info">C. de Área</a>
	         <a href="javascript:seleccionar_ed()" class="btn btn-mini btn-info">Dirección</a>
