			...
			<div class="well">
				...
				<form method="post" action="">
					<fieldset>
								...
								<div class="form-group">
								  <label for="fecha">Fecha</label>
									<div class="input-group">
										<input name="fecha" type="text" class="input form-control" value="<?php echo (isset($id) && $fecha) ? $fecha : date('d-m-Y'); ?>" data-date-format="dd-mm-yyyy" id="fecha" >
					  ...
					  <a class="btn btn-default" href="tutor.php">Nueva intervención</a>
					  <?php else: ?>
