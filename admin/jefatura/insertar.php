...
$todos0 = mysql_query("select distinct claveal, apellidos, nombre from FALUMNOS where nivel = '$nivel' and grupo = '$grupo'");
...
$fecha2 = "$dia[2]-$dia[1]-$dia[0]";
		$query="insert into tutoria (apellidos, nombre, tutor,nivel,grupo,observaciones,causa,accion,fecha, jefatura, prohibido, claveal) values 
		('".$apellidos."','".$nombre."','".$tutor."','".$nivel."','".$grupo."','".$observaciones."','".$causa."','".$accion."','".$fecha2."','1','".$prohibido."','".$clave."')";
		 // echo $query;
mysql_query($query);
echo $query."<br>";
}
