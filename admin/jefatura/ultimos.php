...
echo "<thead><tr><th>Alumno</th><th>Fecha</th></tr></thead><tbody>";
  ...
  {
    $result = mysql_query ("select distinct apellidos, nombre, fecha, accion, causa, observaciones, nivel, grupo, tutor, id, prohibido from tutoria where jefatura = '1' and claveal = '$alumn[2]' order by fecha desc limit 1");
