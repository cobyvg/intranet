	...
	?>
		...
		<div
			...
			<select
				...
				<option value="<?php echo (isset($enfermedad)) ? $enfermedad : ''; ?>"><?php echo (isset($enfermedad)) ? $enfermedad : ''; ?></option>
