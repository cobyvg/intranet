...
<div align="center">
  <input type="button" value="Volver atrás" name="boton" onClick="history.back(2)" class="btn btn-inverse" />
	...
	fclose($handle);
	$borrar0 = mysqli_query($db_con, "delete from morosos where curso = 'ANT' or curso='' or curso='$nombre_del_centro' or curso like 'Abies%'");
	
	$del = mysqli_query($db_con, "select curso, apellidos, nombre, ejemplar, devolución from morosos_tmp");
	while ($delete = mysqli_fetch_array($del)) {
		$dup = mysqli_query($db_con, "select * from morosos where curso = '$delete[0]' and apellidos = '$delete[1]' and nombre = '$delete[2]' and ejemplar = '$delete[3]' and devolucion = '$delete[4]'");
		if (mysqli_num_rows($dup)>0) {}
		else{
	...
	$borrar1 = mysqli_query($db_con, "delete from morosos where curso = 'ANT' or curso='' or curso='$nombre_del_centro' or curso like 'Abies%'");
	
	?>
<div align="center">
<div class="alert alert-success alert-block fade in"><legend>ATENCI&Oacute;N:</legendh5>
