...
<h4 class="modal-title" id="myModalLabel">Instrucciones sobre los Informes de Tutoría.</h4>
</div>
<div class="modal-body">
<p class="help-block">
Los Informes de Tutoría son activados por el Tutor cuando los padres de un alumno solicitan una cita para hablar sobre este. Cuando han sido activados mediante el formulario correspondiente (en el que el Tutor simplemente selecciona al alumno y la fecha de la entrevista con los padres), los profesores del Equipo Educativo del alumno reciben una solicitud de información para que describan el estado y evolución del alumno en su asignatura. La notificación a los profesores aparece en la página de inicio de la Intranet, o bien en la página de Informes de Tutoría. La notificación desaparece cuando hemos rellenado el Informe o la fecha de la entrevista ha pasado. <br>
Una vez recibida la notificación, el profesor entra en un formulario en el que aparece la asignatura (o asignaturas, en el caso de que el profesor imparta más de una al alumno, o éste tenga una asignatura pendiente de continuidad), escribe su informe para el Tutor y envía los datos. Los Informes son visibles en todo momento para el resto de los profesores del alumno.<br><br>
El módulo contiene la posibilidad de ver la totalidad de los Informes a lo largo del Curso Escolar, o bien de buscar entre los Informes los correspondientes a un alumno determinado. Hay que tener en cuenta que, una vez pasada la fecha de la entrevista con los padres, los Informes de Tutoría quedan bloqueados, aunque siguen siendo visibles.<br><br>
El Equipo Directivo dispone de una opción, <b>Control de Informes</b>, que presenta estadísticas por alumno y profesor sobre los Informes de Tutoría.
</p>
</div>
