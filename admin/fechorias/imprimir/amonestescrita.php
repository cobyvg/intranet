...
$result = mysql_query ( "select alma.apellidos, alma.nombre, alma.nivel, 
  ...
  Fechoria.grave, Fechoria.medida, listafechorias.medidas2, Fechoria.expulsion, Fechoria.tutoria, Fechoria.claveal, alma.padre, alma.domicilio, alma.localidad, alma.codpostal, alma.provinciaresidencia, tutor from Fechoria, alma, listafechorias, FTUTORES where FTUTORES.nivel = alma.nivel and FTUTORES.grupo = alma.grupo and  Fechoria.claveal = alma.claveal and listafechorias.fechoria = Fechoria.asunto  and Fechoria.id = '$id' order by Fechoria.fecha DESC" );
