...
for($i = 0; $i < 1; $i ++) {
	...
	// RECIBI
	$txt_recibi = "D./Dña. $padre como representante legal de $nombre $apellidos, alumno/a del grupo $unidad, he recibido la $titulo con referencia Fec/".$row['id']." registrado el ".strftime("%e de %B de %Y", strtotime($fecha)).".";
