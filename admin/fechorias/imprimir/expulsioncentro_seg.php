...
if (mysql_num_rows ( $repe ) == "0") {
	 mysql_query ( "INSERT into tareas_alumnos (CLAVEAL,APELLIDOS,NOMBRE,NIVEL,GRUPO,FECHA,DURACION,PROFESOR) VALUES ('$claveal','$apellidos','$nombre','$nivel','$grupo', '$fecha','$expulsion','$tutor')" ) or die ( "Error, no se ha podido activar el informe:" . mysql_error () );
} 
