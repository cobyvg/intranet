...
echo "<img src='../../xml/fotos/$claveal.jpg' border='2' width='100' height='119' style='margin-bottom:-145px' class='img-thumbnail img-circle pull-right hidden-phone' />";
	...
	<td>$row[1]</td>
	<td>$row[2]</td>
	<td nowrap><a href='detfechorias.php?id= $row[3]&claveal=$claveal' data-toggle='tooltip' title='Detalles'><i class='fa fa-search fa-fw fa-lg'></i></a><a href='delfechorias.php?id= $row[3]' data-toggle='tooltip' title='Eliminar'><i class='fa fa-trash-o fa-fw fa-lg'></i></a></td>
	</tr>";
	}
	echo "</table>\n";
    ?>
