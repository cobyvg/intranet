...
El campo <em><b>Alumno/a</b></em> presenta al principio la lista de todos los alumnos del Centro ordenada alfabéticamente. Si elegimos un Grupo aparecerán  los alumnos de ese Grupo. Tanto en la lista total como en la lista de un Grupo podemos selecccionar uno o varios alumnos. Como se señala en el texto de ayuda del formulario, se pueden seleccionar múltiples alumnos mediante el uso de la tecla CTRL + click sobre los distintos elementos; si queremos seleccionar a todo el Grupo, hacemos click sbre el primero de la lista y, manteniendo presionada la tecla Mayúsculas (SHIFT), seleccionamos el útlimo de la lista.<br><br>
El segundo bloque de campos del formulario comienza con la elección de la <em><b>Gravedad</b></em> del Problema que vamos a registrar. La Gevedad puede ser: Leve, Grave y Muy Grave. Cada categoría va asociada a un conjunto de <em><b>Conductas Negativas</b></em> que aparecen en el ROF (Reglamento de Organización y Funcionamiento) del Centro y que puede ser editado por parte de los Administradores de la Intranet (Administracción de la Intranet --> A principio de Curso --> Modificar ROF). Al cargar una de las categorías, el desplegable muestra las Conductas Negativas propias de esa categoría. Seleccionamos una Conducta y aparecerán al mismo tiempo la <em><b>Medida Adoptada</b></em> administrativamente (si procede según el ROF) y las <em><b>Medidas Complementarias</b></em> que deben tomarse (según el ROF). Si el alumno ha sido <em><b>expulsado del Aula</b></em>, debe marcarse la opción correspondiente. <br><br>
...
<li class="text-info">Los Problemas de Convivencia caducan según el tiempo especificado en el ROF. Los valores por defecto de la aplicación son los siguinetes: 30 días para los Leves y Graves; 60 días para los Muy Graves.</li>
...
presionada la tecla <em>Ctrl</em> mientras haces click con el ratón
sobre los mismos. <br>Si has seleccionado un Grupo y quieres registrar un Problema a todo los alumnos del Grupo, marca con el ratón el primer alumno y, mientras mantines pulsada la tecla <em>Mayúsculas (Shift)</em>, marca el último de los alumnos para seleccionarlos a todos.</p>
<?
}
?>
