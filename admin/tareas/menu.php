  ...
  <div class="navbar-inner2">
    ...
    <div class="convive">
      ...
      <a class="brand" href="http://<? echo $dominio;?>/intranet/index0.php" style="color:#2c2c2c">Informes de Tareas</a>
      <div id="convive" class="nav-collapse collapse">
        <ul class="nav nav-pills">
<li> <a href="index.php">Página de Informes de Tareas</a></li>
<?
...
?>
     <li><a href="infotut.php?nivel=<? echo $nivel;?>&grupo=<? echo $grupo;?>&tutor=<? echo $tutor;?>">Activar Nuevo Informe</a></li>
     <? }?>
