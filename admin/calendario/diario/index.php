					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td nowrap>
									<a href="index.php?id=<?php echo $row['id']; ?>"><span class="fa fa-edit fa-fw fa-lg" data-toggle="tooltip" title="Editar"></span></a>&nbsp;
									<a href="index.php?id=<?php echo $row['id']; ?>&borrar=1" data-toggle="tooltip" title="Eliminar" data-bb='confirm-delete'><span class="fa fa-trash-o fa-fw fa-lg"></span></a>
								</td>
							</tr>
							<?php endwhile; ?>
						</tbody>
