...
<? include("menu_informes.php"); ?>
  ...
  <br>
  <p class="help-block">** La Columna <mark>Por Grupo</mark> presenta el número de faltas que el profesor ha puesto en cada uno de sus Grupos (entre paréntesis, primero la abreviatura de la asignatura y luego el número de alumnos de su asignatura); la columna <mark>Media Grupos</mark> presenta la media de faltas que todos los Profesores han puesto en cada uno de esos Grupos</p>
  <hr>
