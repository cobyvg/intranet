...
<table class="table" style="width:920px">
      <tr>
        <th  colspan="2" style="background-color:#eee"><h6>PUNTO DE PARTIDA SOBRE LAS TIC. </h6></th>
        </tr>
      <tr>
        <td style="width:25%"><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/TIC_como_agentes_innovacion.pdf" target="_blank">Las TIC como Agentes de innovacion</a> </td>
      ...
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/guia_centros_tic.pdf" target="_blank">Guia de los Centros TIC</a> </td>
      ...
      <tr>
        <th  colspan="2" style="background-color:#eee"><h6>HARDWARE</h6></th>
        </tr>
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/MAN-toshiba-es.pdf">Manual del Portatil TOSHIBA </a></td>
      ...
      <tr>
        <th  colspan="2" style="background-color:#eee"><h6>GUADALINEX</h6></th>
        </tr>
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/Guia_Guadalinex_V3.pdf" target="_top">Guia de Guadalinex V.3.1</a> </td>
      ...
      <tr>
        <th  colspan="2" style="background-color:#eee"><h6>APLICACIONES IMPORTANTES EN GUADALINEX </h6></th>
        </tr>
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/openoffice_writer.pdf">Procesador de textos de OpenOffice </a></td>
        <td>Introducion a la aplicacion de textos de OpenOffice.</td>
      </tr>
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/gimp.pdf">Gimp (Graficos)</a> </td>
      ...
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/paginas_web_con_composer.pdf">Composer (Creacion de Paginas Web)</a> </td>
      ...
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/xsane_manual_escanear.pdf">XSane (Escaner)</a> </td>
      ...
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/CanonVirtual.pdf">Ca&ntilde;on Virtual </a></td>
      ...
      <tr>
        <th  colspan="2" style="background-color:#eee"><h6>PLATAFORMA EDUCATIVA </h6>          
          <div align="center"></div></td>
        </tr>
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/Manual_Plataforma_Educativa.pdf">Manual de la Plataforma Educativa </a></td>
      ...
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/plataforma_e-ducativa.pdf">Plataforma E-Ducativa </a></td>
        <td>Otro manual de uso de la Plataforma. </td>
      </tr>
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="ftp://iesmonterroso.org/departamentos/TIC/plataformaIVcontenidos.doc">Contenidos en la Plataforma </a></td>
        <td>Instrucciones para crear contenidos para los alumnos, quizas la parte fundamental de la Plataforma. </td>
      </tr>
      <tr>
        <th  colspan="2" style="background-color:#eee"><h6>ENLACES INTERESANTES </h6></th>
        </tr>
      <tr>
        <td><i class="fa fa-tags"> </i> <a href="http://www.juntadeandalucia.es/averroes/cga">Centro de Gesti&oacute;n Avanzado de centros TIC </a></td>
