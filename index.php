				...
				<div class="bs-module hidden-xs">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<h4 class="text-center">
								<a href="admin/fechorias/fechorias.php?dia=<?php echo date('d-m-Y'); ?>">
									...
									<small class="text-uppercase">problemas de convivencia</small>
								</a>
							</h4>
						</div>
						...
						<div class="col-sm-3">
							...
							<h4 class="text-center">
								<a href="admin/fechorias/expulsados.php">
									<span class="lead">
										<?php echo $row['total']; ?> / <?php echo $row1['total']; ?>
									</span><br>
									<small class="text-uppercase">alumnos expul. / reinc.</small>
								</a>
							</h4>
						</div>
						...
						<div class="col-sm-3">
							...
							<h4 class="text-center">
								<a href="admin/jefatura/index.php">
									...
									<small class="text-uppercase">intervenciones a alumnos</small>
								</a>
							</h4>
						</div>
						
						<div class="col-sm-3">
							<?php $result = mysqli_query($db_con, "SELECT COUNT(DISTINCT profesor) AS total FROM reg_intranet WHERE fecha LIKE CONCAT(CURDATE(),'%')"); ?>
							<?php $row = mysqli_fetch_array($result); ?>
							<?php mysqli_free_result($result); ?>
							
							<?php $result1 = mysqli_query($db_con, "SELECT COUNT(*) AS total FROM c_profes"); ?>
							<?php $row1 = mysqli_fetch_array($result1); ?>
							<?php mysqli_free_result($result1); ?>
							
							<h4 class="text-center">
								<a href="xml/jefe/informes/accesos.php">
									<span class="lead">
										<?php echo $row['total']; ?> <span class="text-muted">/ <?php echo $row1['total']; ?></span>
									</span><br>
									<small class="text-uppercase">profesores han accedido</small>
								</a>
							</h4>
						</div>
					</div>
