...
Es posible importar los horarios con el archivo de tipo DEL que se genera con Horwin, pero esta opción sólo debe utilizarse excepcionalmente. La opción preferida y más completa es el archivo XML.<br>
Si disponemos de horario (incluso si no contamos con él, puesto que otros módulos de la Intranet como el Calendario los necesitan), es necesario proceder a la importación de los días festivos y de la jornada escolar. Las instrucciones sobre el lugar donde encontrar los archivos de Séneca para descargar se encuentran en las páginas correspondientes.</li>
