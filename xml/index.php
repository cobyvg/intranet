	...
	<div class="row">
		...
		<div class="col-sm-8">
			...
			El <strong>cuarto grupo de opciones</strong> afecta a los <strong><span class="text-info">Profesores</span></strong>.<br> 
			 ...
			 <span class="text-info">Copiar datos de un profesor a otro</span> cambia los datos de un profesor que ha sido sustituido por los datos del profesor que lo sustituye, de tal manera que el nuevo profesor pueda entrar en la Intranet con los datos heredados del profesor sustituido.<br>
