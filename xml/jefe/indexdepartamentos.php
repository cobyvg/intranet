...
<div class="page-header" align="center">
  <h2>Administración <small> Creación de la tabla de Departamentos</small></h2>
</div>
...
<br />
<div align="center">
  <input type="button" value="Volver atrás" name="boton" onClick="history.back(2)" class="btn btn-sucess" />
</div>
</div>
</body>
</html>
