				...
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td nowrap>
								<a href="restaurar.php?archivo=<?php echo $archivo; ?>" data-toggle="tooltip" title="Restaurar"><span class="fa fa-undo fa-lg fa-fw"></span></a>
								<a href="index.php?action=descargar&archivo=<?php echo $archivo; ?>" data-toggle="tooltip" title="Descargar"><span class="fa fa-cloud-download fa-lg fa-fw"></span></a>
								<a href="index.php?action=eliminar&archivo=<?php echo $archivo; ?>" data-bb="confirm-delete" data-toggle="tooltip" title="Eliminar"><span class="fa fa-trash-o fa-lg fa-fw"></span></a>
							</td>
						</tr>
					</tbody>
					<?php endif; ?>
