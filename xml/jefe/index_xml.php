    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="span6 offset3">
				...
				?>
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="index_xml.php">
                	<fieldset>
                	    <legend>Importación de los datos del centro</legend>
                	    
                	    <p>Este módulo se encarga de importar la relación de <strong>cursos</strong> y <strong>unidades</strong> del Centro registrados en Séneca, asi como la relación de <strong>materias</strong> que se imparten y <strong>actividades</strong> del personal docente, necesarias para comprobar la coherencia de los horarios y poder realizar tareas de depuración. Se importará también la relación de <strong>dependencias</strong>, que se utilizará para realizar reservas de aulas o consultar el horario de aulas.</p>
                	    ...
                	    <div class="well" align="center">
  							  <label for="file1">Selecciona el archivo descargado de Séneca:
  							  </label>
  							  <hr />
                	          <input type="file" name="ExpGenHor" accept="text/xml" id="file1" required>
                	          <input type="hidden"  name="curso_escolar" value="<? echo $curso_actual;?>">
                	    </div>
