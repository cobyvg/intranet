...
<div class="page-header" align="center" style="margin-top:-15px;">
  <h1>Administración <small> Importación de fotos de los profesores</small></h1>
</div>
<br />
<FORM ENCTYPE="multipart/form-data" ACTION="fotos_profes.php" METHOD="post">
  ...
  <h5><small>Selecciona el archivo comprimido con las fotos de los profesores</small></h5><br />
