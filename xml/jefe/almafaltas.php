...
<div class="page-header" align="center">
  <h2>Administraci贸n <small> Creaci贸n de la tabla de alumnos</small></h2>
</div>
<br />
...
mysql_query($alumnos) or die ('<div align="center"><div class="alert alert-danger alert-block fade in" style="max-width:500px;">
			...
			<legend>ATENCI覰:</legend>
No se ha podido crear la tabla <strong>Alma</strong>. Ponte en contacto con quien pueda resolver el problema.
</div></div><br />
<div align="center">
  <input type="button" value="Volver atr谩s" name="boton" onClick="history.back(2)" class="btn btn-inverse" />
</div>');

  $SQL6 = "ALTER TABLE  `alma` ADD INDEX (  `CLAVEAL` )";
  $result6 = mysql_query($SQL6);
  
// Importamos los datos del fichero CSV (todos_alumnos.csv) en la tab帽a alma.
...
$fp = fopen ($_FILES['archivo1']['tmp_name'] , "r" ) or die('<div align="center"><div class="alert alert-danger alert-block fade in" style="max-width:500px;">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
			<h5>ATENCI脫N:</h5>
No se ha podido abrir el archivo RegAlum.txt. O bien te has olvidado de enviarlo o el archivo est谩 corrompido.
</div></div><br />
<div align="center">
  <input type="button" value="Volver atr谩s" name="boton" onClick="history.back(2)" class="btn btn-inverse" />
</div>'); 
...
// Separamos Nivel y Grupo si sigue el modelo cl醩ico del gui髇 (1E-F, 2B-C, etc)
...
$actualiza= "UPDATE alma SET NIVEL = '$trozounidad0[0]', GRUPO = '$trozounidad0[1]' where CLAVEAL = '$row0[1]'";
 ...
 while  ($row3 = mysql_fetch_array($result3))
 {
  ...
  // Eliminaci贸n de campos innecesarios por repetidos
  ...
  // Eliminaci贸n de alumnos dados de baja
  $SQL4 = "DELETE FROM alma WHERE `unidad` = ''";
  $result4 = mysql_query($SQL4);
  
// Exportamos c贸digos de asignaturas de los alumnos y CLAVEAL1 para las consultas de evaluaci贸n
if(phpversion() < '5'){
...
$SQL6 = "DELETE FROM alma WHERE (COMBASI IS NULL and (unidad like '%E-' or unidad like '%B-' or unidad like '%P-') and ESTADOMATRICULA != 'Obtiene T韙ulo' and ESTADOMATRICULA != 'Repite' and ESTADOMATRICULA != 'Promociona' and ESTADOMATRICULA != 'Pendiente de confirmacion de traslado')";
$result6 = mysql_query($SQL6);
// Eliminamos a los alumnoos de Ciclos con algun dato en estadomatricula
$SQL7 = "DELETE FROM alma WHERE ESTADOMATRICULA != '' and ESTADOMATRICULA != 'Obtiene T憝tulo' and ESTADOMATRICULA != 'Repite' and ESTADOMATRICULA != 'Promociona'  and ESTADOMATRICULA != 'Pendiente de confirmacion de traslado'";
mysql_query($SQL7);
...
mysql_query($SQL8);
 ...
 // Creamos versi贸n corta para FALTAS
...
<div align="center">
  <input type="button" value="Volver atr醩" name="boton" onClick="history.back(2)" class="btn btn-inverse" />
</div>');
// Claveal primaria e 铆ndice
...
// Copia de la primera versi贸n de alma
...
mysql_query("ALTER TABLE  `FALUMNOS_primero` ADD INDEX (  `CLAVEAL` )");
	...
	echo '<div align="center"><div class="alert alert-danger alert-block fade in" style="max-width:500px;">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
			<legend>ATENCI訐N:</legend>
Parece que te est醩 olvidando de enviar todos los archivos con los datos de los alumnos. Aseg鷕ate de enviar ambos archivos descargados desde S閚eca.
</div></div><br />';
}
?>
<br />
