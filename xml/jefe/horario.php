...
?>
	...
	<div class="container">
		...
		<div class="alert alert-warning">
			Ya existe información en la base de datos. Este proceso actualizará la información de los horarios. Es recomendable realizar una <a href="copia_db/index.php" class="alert-link">copia de seguridad</a> antes de proceder a la importación de los datos.
		</div>
		<?php endif; ?>
						...
						<form method="POST" action="horario.php" enctype="multipart/form-data">
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="checkbox">
										<label>
											<input type="checkbox" id="depurar"	name="depurar" value="1"> Modo depuración <small>(solo para la opción Generar XML)</small>
										</label>
									</div>
								</div>
  ...
  <div align="center">
    <INPUT type="submit" name="enviar" value="Aceptar" class="btn btn-primary">
			...
			<div class="col-sm-6">
				...
				<legend>Información sobre la importación con archivo XML</legend>
	...
	<p>
	La importación de los horarios con el archivo DEL creado por Horwin es una opción que sólo debe ser utilizada si no contamos con el archivo XML, que es la opción preferida. Se mantiene para aquellos casos en los que no tenemos a mano el XML para exportar a Séneca. Las preferencias de generación del archivo DEL aparecen marcadas en la imagen de abajo.
	</p>
<img border="0" src="exporta_horw.jpg">
			</div><!-- /.col-sm-6 -->
